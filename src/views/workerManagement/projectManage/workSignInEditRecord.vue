  ...
  <div class="attendance"  v-loading="loading">
      ...
      <div class="top-content flex fvertical fbetween">
        <div class="top-content-item flex fvertical">
          <div class="flex fvertical top-content-item-status">
            <span>用户名：</span>
            <el-input v-model="serachPro" clearable class="top-content-item-input" placeholder="用户ID/账号/手机号" />
          </div>
          <div class="flex fvertical top-content-item-status">
            <span>变更时间：</span>
            <el-date-picker
          ...
          <div class="flex fvertical top-content-item-status">
            <span>操作人：</span>
            <el-input v-model="serachPeople" clearable class="top-content-item-input" placeholder="手机号/账号" />
          </div>
        </div>
    ...
    <div class="box">
      ...
      <el-table :data="tableData" stripe style="width: 100%" border :height="clientHeight+'px'">
        ...
        <el-table-column label="上班签到">
         <template slot-scope="scope">
           <p style="color: #1890ff;">{{scope.row.status}}</p>
         </template>
        </el-table-column>
        <el-table-column label="下班签到">
         <template slot-scope="scope">
           <p style="color: #1890ff;">{{scope.row.name}}</p>
         </template>
        </el-table-column>
        <el-table-column prop="name" label="操作备注"/>
