			...
			<div class="top-content flex fvertical fbetween">
				<div class="top-content-item flex fvertical">
					<div class="flex fvertical top-content-item-status">
						<span>输入查询：</span>
						<el-input v-model="serach" clearable class="top-content-item-input"
							placeholder="用户ID/手机号码/真实姓名" />
					</div>
					<div class="flex fvertical top-content-item-status">
						<span>状态：</span>
	...
	export default {
		...
		methods: {
			...
			exportTable() {
				...
				let url = '/api/user/admin/userRealNameApply/v1.0/exportCsv';
				let param =
					`?pageSize=${this.PageSize}&pageNum=${this.PageIndex}&status=${this.statusvalue}&keyword=${this.serach}`
