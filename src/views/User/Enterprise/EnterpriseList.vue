			...
			<div class="top-content flex fvertical fbetween">
				<div class="top-content-item flex fvertical">
					<div class="flex fvertical top-content-item-status">
						<span>输入查询：</span>
						<el-input v-model="serach" style="width: 240px;" class="top-content-item-input"
							placeholder="用户ID/企业名称/姓名/手机号" clearable />
					</div>
					<div class="flex fvertical top-content-item-status">
						<span>需求单数量：</span>
						<div class="flex alCen flex1">
							<el-input v-model="xqMinNum" type="number" class="numIpt" placeholder="请输入" clearable>
							</el-input>
							<div style="margin: 0 10px;">-</div>
							<el-input v-model="xqMaxNum" type="number" class="numIpt" placeholder="请输入" clearable>
							</el-input>
						</div>
					</div>
					<div class="flex fvertical top-content-item-status">
						<span>服务单数量：</span>
						<div class="flex alCen flex1">
							<el-input v-model="fwMinNum" type="number" class="numIpt" placeholder="请输入" clearable>
							</el-input>
							<div style="margin: 0 10px;">-</div>
							<el-input v-model="fwMaxNum" type="number" class="numIpt" placeholder="请输入" clearable>
							</el-input>
						</div>
					</div>
				</div>
		...
		<div class="box">
			...
			<el-table :data="tableData" stripe style="width: 100%" border :height="clientHeight+'px'">
				...
				<el-table-column prop="enterpriseStatus" label="状态">
					<template slot-scope="scope">
						<el-switch v-model="scope.row.enterpriseStatus" :active-value="0" :inactive-value="1"
							@change="enterpriseStatusChange(scope.row)" active-color="#0079fe" inactive-color="#e5dbe5">
						</el-switch>
				...
				<el-table-column label="操作" width="220">
					<template slot-scope="scope">
						...
						<el-button v-if="scope.row.enterpriseAuth==0" type="text" size="small"
							@click="authen(scope.row)">企业认证</el-button>
					</template>
				</el-table-column>
			</el-table>
			<!-- 表格end -->
			...
			<!-- 企业认证 -->
			<el-dialog title="添加企业认证" :visible.sync="qiyeRZPop" width="30%" center>
				<div class="reanNamePoplist reanNamePoplist2">
					...
					<div class="item">
						...
						<input type="text" name="" v-model="businessLicenseRegistrationNo" placeholder="请输入营业执照注册号"
							class="ipt" value="">
					</div>
					<div class="item">
						<p class="tit">法人姓名：</p>
						<input type="text" name="" v-model="legalRepresentativeName" placeholder="请输入法人姓名" class="ipt"
							value="">
					</div>
					<div class="item">
						<p class="tit">运营者姓名：</p>
					...
					<div class="item">
						...
						<input type="text" name="" v-model="operatorMobileNo" placeholder="请输入运营者联系电话" class="ipt"
							value="">
					</div>
					<div class="item">
						<p class="tit">身份证号：</p>
...
<script>
	...
	export default {
		...
		methods: {
			...
			// 导出
			exportTable() {
				let url = '/api/user/admin/enterprise/v1.0/exportCsv';
				let param =
					`?id=${this.serach}&pageNum=${this.PageIndex}&pageSize=${this.PageSize}&userStatus=${this.statusvalue}`
